...
### film
data.shape <- read.csv("data (public)//film age gap//data.shape.csv",
                       stringsAsFactors = FALSE, na = "")

data2 <- read.csv("data (public)//film age gap//data2.csv",
                  stringsAsFactors = FALSE, na = "")


### census
census <- read.csv("data (public)//film age gap//rolf.ferrie.gap.csv",
                   stringsAsFactors = FALSE, na = "")
