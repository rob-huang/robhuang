...
load(file = "data (public)//la_roadmap.RData")
...
# regions
la.neigh <- read.csv("data (public)//la neighborhoods.csv", stringsAsFactors = FALSE)


### neighborhood shapes
la.neigh.shp <- st_read("data (public)//la_county.shp//la_county.shp")
